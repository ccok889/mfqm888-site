...
const searchIndex=[
  ...
  {title:'模仿笔迹样本里没有相同字怎么办？偏旁与相近结构整理方法',url:'article/mofang-biji/missing-same-characters-sample.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 模仿笔迹',description:'模仿笔迹样本里没有相同字怎么办？偏旁与相近结构整理方法，围绕模仿笔迹、模仿签名、模仿签字与笔迹鉴定说明自然样本和文件整理方法。',category:'模仿笔迹',date:'2026-08-25',image:'assets/images/handwriting-analysis-lens-v2.jpg'},
  ...
  {title:'模仿签字照片怎么选？不同场景、书写工具与纸张的影响',url:'article/mofang-qianming/signature-photo-scene-differences.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 模仿签名',description:'模仿签字照片怎么选？不同场景、书写工具与纸张的影响，围绕模仿笔迹、模仿签名、模仿签字与笔迹鉴定说明自然样本和文件整理方法。',category:'模仿签名',date:'2026-08-25',image:'assets/images/business-signing.jpg'},
  {title:'笔迹鉴定为什么重视同期样本？形成时间与自然变化说明',url:'article/biji-jianding/same-period-comparison-samples.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 笔迹鉴定',description:'笔迹鉴定为什么重视同期样本？形成时间与自然变化说明，围绕模仿笔迹、模仿签名、模仿签字与笔迹鉴定说明自然样本和文件整理方法。',category:'笔迹鉴定',date:'2026-08-25',image:'assets/images/document-comparison-v2.jpg'},
  ...
  {title:'手写样本完整页与细节图提交方式更新',url:'article/news/full-page-detail-image-update.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 资讯',description:'手写样本完整页与细节图提交方式更新，围绕模仿笔迹、模仿签名、模仿签字和笔迹鉴定更新资料整理说明。',category:'资料指南',date:'2026-08-25',image:'assets/images/handwriting-samples-flatlay-v2.jpg'},
  {title:'多时期签名与笔迹对比专题内容上线',url:'article/news/multi-period-signature-comparison-topic.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 资讯',description:'多时期签名与笔迹对比专题内容上线，围绕模仿笔迹、模仿签名、模仿签字和笔迹鉴定更新资料整理说明。',category:'专题内容',date:'2026-08-25',image:'assets/images/document-comparison-v2.jpg'},
  ...
  {title:'模仿笔迹短句与整页内容有什么区别？样本和版式准备方法',url:'article/mofang-biji/short-sentence-full-page-differences.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 模仿笔迹',description:'模仿笔迹短句与整页内容有什么区别？样本和版式准备方法，围绕模仿笔迹、模仿签名、模仿签字和笔迹鉴定说明自然样本与文件整理方法。',category:'模仿笔迹',date:'2026-08-31',image:'assets/images/handwritten-documents.jpg'},
  {title:'模仿签名为什么需要多次重复签写？稳定特征与自然变化',url:'article/mofang-qianming/repeated-signatures-stable-features.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 模仿签名',description:'模仿签名为什么需要多次重复签写？稳定特征与自然变化，围绕模仿笔迹、模仿签名、模仿签字和笔迹鉴定说明自然样本与文件整理方法。',category:'模仿签名',date:'2026-08-31',image:'assets/images/signature-sample-cards.jpg'},
  {title:'笔迹鉴定图片被压缩会丢失什么？原图、截图与扫描件比较',url:'article/biji-jianding/compressed-images-detail-loss.html',keywords:'模仿笔迹 模仿签名 模仿签字 笔迹鉴定 笔迹鉴定',description:'笔迹鉴定图片被压缩会丢失什么？原图、截图与扫描件比较，围绕模仿笔迹、模仿签名、模仿签字和笔迹鉴定说明自然样本与文件整理方法。',category:'笔迹鉴定',date:'2026-08-31',image:'assets/images/document-comparison-v2.jpg'}
];
